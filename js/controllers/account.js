    ...
    function(scope, root, state) {
        ...
        scope.change_email = function(new_email) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    root.error(
                        "We could not change your email address. Try again later."
                    );
                    root.$apply();
                }
            });
        ...
        scope.change_first_name = function(new_first_name) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    console.log("error", data);
                    root.error(
                        "We could not change your first name. Try again later."
                    );
                    root.$apply();
                }
            });
        ...
        scope.change_last_name = function(new_last_name) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    root.error(
                        "We could not change your last name. Try again later."
                    );
                    root.$apply();
                }
            });
        ...
        scope.delete_account = function() {
            ...
            $.ajax({
                ...
                error: function(data) {
                    console.log("error", data);
                    root.error(
                        "We could not delete your account. Try again later."
                    );
                    root.$apply();
                }
            });
        ...
        //LISTENERS
        root.$on("share_set_status", function() {
            scope.get_designs();
        });
    }
]);
