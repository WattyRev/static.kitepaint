app.controller("PrimaryController", [
    ...
    "$location",
    "$window",
    function(scope, root, state, $location, $window) {
        //VARIABLES
        scope.current_page = "";
        root.base_url =
            environment === "development"
                ? "http://wattydev.com/projects/kite_paint"
                : "https://kitepaint.com";
        root.has_account = localStorage.kp_has_account
            ? localStorage.kp_has_account === "true"
            : false;
        root.sign_in = {
            username: "",
            password: ""
        ...
        root.login = function(callback) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    ...
                    root.login_loading = undefined;
                    root.login_message =
                        data.message || "Unable to log in. Try again later.";
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.registered) {
                        ...
                        root.success(
                            "You have created an account. An activation email has been sent to your email address."
                        );
                ...
                error: function(data) {
                    ...
                    root.register_status = "invalid";
                    root.registering = undefined;
                    root.register_message =
                        data.message || "Unable to register. Try again later.";
